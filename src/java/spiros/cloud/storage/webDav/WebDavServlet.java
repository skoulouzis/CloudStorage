 ...
 */
package spiros.cloud.storage.webDav;
...
import spiros.cloud.storage.webDav.resources.CloudResourceFactory;
import spiros.cloud.storage.webDav.resources.CloudResourceFactoryFactory;
...
//            }
    ...
    protected void init(String responseHandlerClassName, List<String> authHandlers) throws ServletException, URISyntaxException, VlException, IOException {
        ...
        ResourceFactory rf = new CloudResourceFactory();
    ...
    protected void initFromFactoryFactory(List<String> authHandlers) throws ServletException {
        com.bradmcevoy.http.ResourceFactoryFactory rff = new CloudResourceFactoryFactory();
        rff.init();
